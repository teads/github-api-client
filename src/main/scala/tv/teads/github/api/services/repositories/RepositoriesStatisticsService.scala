...
class RepositoriesStatisticsService(config: GithubApiClientConfig) extends AbstractGithubService(config) {
  ...
  def contributorsStatistics(repository: String)(implicit ec: EC): Future[Option[List[ContributorStatistics]]] =
    jsonOptionalIfFailed[List[ContributorStatistics]](
  ...
  def lastYearCommitActivity(repository: String)(implicit ec: EC): Future[Option[List[WeeklyCommitCount]]] =
    jsonOptionalIfFailed[List[WeeklyCommitCount]](
  ...
  def weeklyAdditionsDeletions(repository: String)(implicit ec: EC): Future[Option[List[WeeklyAdditionsDeletions]]] =
    jsonOptionalIfFailed[List[WeeklyAdditionsDeletions]](
  ...
  def hourlyCommitCount(repository: String)(implicit ec: EC): Future[Option[List[HourlyCommitCount]]] =
    jsonOptionalIfFailed[List[HourlyCommitCount]](
